<?	include_once "include/config.inc.php";
	...
	$oObj2 = new EquipoIdeal();
	$aEquipoIdeal = $oObj2 -> getByIdTorneoCat($id);
  ...
  <div id="wrap">
    ...
    <div id="cabezal1">
      ...
      <div id="imagen" style="float:left; vertical-align:top">
        ...
        <div style="float:left; margin-left:48px;height: 780px" > <img src="img/cancha/cancha.jpg" />
          <div id="posicion1" align="center">
            <?=$aEquipoIdeal[0]['jugadora']?>
            <br />
            <?=$aEquipoIdeal[0]['equipo']?>
            <br />
          </div>
          <div id="posicion2" align="center">
            <?=$aEquipoIdeal[1]['jugadora']?>
            <br />
            <?=$aEquipoIdeal[1]['equipo']?>
            <br />
          </div>
          <div id="posicion3" align="center">
            <?=$aEquipoIdeal[2]['jugadora']?>
            <br />
            <?=$aEquipoIdeal[2]['equipo']?>
            <br />
          </div>
          <div id="posicion4" align="center">
            <?=$aEquipoIdeal[3]['jugadora']?>
            <br />
            <?=$aEquipoIdeal[3]['equipo']?>
            <br />
          </div>
          <div id="posicion5" align="center">
            <?=$aEquipoIdeal[4]['jugadora']?>
            <br />
            <?=$aEquipoIdeal[4]['equipo']?>
            <br />
          </div>
        </div>
      </div>
