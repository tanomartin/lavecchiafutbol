...
<script language="javascript">
	...
	function password(id){
		...
		document.frm_listado.accion.value = "password";
    ...
    <div class="inside">
		...
		<div class="mod_article block" id="home">
			...
			<table width="928">
				...
				<tr>
						<td colspan="4" align="center">No existen equipos</td>
			  </tr>
					...
					<tr>
                     ...
                     <td align="left"><?=$datos[$i]["categoria"]?></td>
                      <td nowrap>
						...
						<a href="javascript:password(<?=$datos[$i]["id"]?>);"><img border="0" src="images/icono-pass.png" alt="contraseña" title="contraseña" /></a>
