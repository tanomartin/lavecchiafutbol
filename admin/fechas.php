<?	include_once "include/config.inc.php";
	...
	switch ($_POST["accion"]) {
		...
		case "horasCancha":
			...
			include("fechas.horasCancha.php");
			exit;
			break;
...
<script language="javascript">
	...
	function horasCancha(id){
		...
		document.frm_listado.accion.value = "horasCancha";
					...
					<tr>
                     ...
                     <td align="left"><?=$datos[$i]["categoria"]?></td>
                      <td nowrap>
					   ...
					   <a href="javascript:horasCancha(<?=$datos[$i]["id"]?>);"><img border="0" src="images/icono-horas.png" alt="horas" title="horas cancha" /></a>
